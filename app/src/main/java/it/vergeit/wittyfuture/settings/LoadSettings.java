...
import it.vergeit.wittyfuture.theme.bin.Theme;
import it.vergeit.wittyfuture.theme.bin.ThemeAssets;
...
public class LoadSettings {
    ...
    private final ThemeAssets themeAssets;
...
//    }
    ...
    public LoadSettings(Context context,@Nullable String themeName ) {
