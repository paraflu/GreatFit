...
import it.vergeit.wittyfuture.data.MultipleWatchDataListenerAdapter;
import it.vergeit.wittyfuture.widget.AnalogClockWidget;
import it.vergeit.wittyfuture.widget.ClockWidget;
import it.vergeit.wittyfuture.widget.DigitalClockWidget;
